...
{
    public abstract class BaseSampleStep3DAsync<T> : BaseSampleStep
    {
        ...
        protected BaseSampleStep3DAsync(float x, float y, int pxIndex, int pyIndex, int pzIndex, ref T[,,] values)
        {
            m_X = x;
            m_Y = y;
            m_PxIndex = pxIndex;
