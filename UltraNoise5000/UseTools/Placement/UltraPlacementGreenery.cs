...
{
    public class UltraPlacementGreenery : MonoBehaviour
    {
        ...
        private GreeneryManager m_GreeneryManager;

        private GreeneryManager greeneryManager
        {
            get {
                if (m_GreeneryManager == null) {
                    m_GreeneryManager = GetComponent<GreeneryManager>();
                }
                return m_GreeneryManager;
            }
        }
        ...
        public void ClearObjects()
        {
            for (var i = 0; i < placementItems.Count; i++)
            {
                ...
                PlacementGreenery itemSettings = item.settings as PlacementGreenery;
                greeneryManager.ClearSpawnPoints(itemSettings.item);
            }
        ...
        public void PerformPlacement()
        {
            ...
            for (var i = 0; i < totalPlacementItems; i++)
            {
                ...
                PlacementGreenery greenerySettings = settings as PlacementGreenery;
                    ...
                    for (var y = 0; y < yAmount; y++) {
                        for (var z = 0; z < zAmount; z++) {
                            ...
                            } else
                            {
                                ...
                                for (int j = 0; j < greenerySettings.copies; j++)
                                {
                                    greeneryManager.AddSpawnPoint(greenerySettings.item,
                                        greenerySettings.PlaceSpawnPoint(pos, sample, transform));
                                }
