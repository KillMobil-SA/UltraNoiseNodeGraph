...
namespace NoiseUltra
{
    public class UltraNoiseTerrainPainter : MonoBehaviour
    {
        ...
        IEnumerator TerraPaint()
        {
            ...
            float[,,] splatmapData = new float[myTerrainData.alphamapWidth, myTerrainData.alphamapHeight,
        ...
        public class PaintItem
        {
            ...
            [ShowIf("isAnglePaint", true)] public float angleDivide = 1;
            [ShowIf("isAnglePaint", true)] public AnimationCurve clifCurve = AnimationCurve.Linear(0, 0, 1, 1);
