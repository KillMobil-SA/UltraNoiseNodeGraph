...
namespace XNodeEditor
{
    public class OutputAttributeDrawer : OdinAttributeDrawer<Node.OutputAttribute>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            {
                if (Attribute.backingValue == Node.ShowBackingValue.Always ||
                    Attribute.backingValue == Node.ShowBackingValue.Unconnected && !port.IsConnected)
            ...
            if (port != null)
            {
                ...
                else
                {
                    ...
                    NodeEditorGUILayout.PropertyField(portPropoerty, label == null ? GUIContent.none : label, true,
